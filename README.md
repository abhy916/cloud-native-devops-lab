...
Grafana was connected to Prometheus and the same query was successfully executed through Grafana Explore, confirming the complete monitoring flow:
...
The EC2 instance uses an IAM role with Systems Manager and ECR permissions, while Jenkins has permissions to discover the target EC2 instance and submit/check SSM commands.
